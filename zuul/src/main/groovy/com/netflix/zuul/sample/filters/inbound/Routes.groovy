...
class Routes extends HttpInboundSyncFilter {
    ...
    HttpRequestMessage apply(HttpRequestMessage request) {
        /**
         * SessionContext表示在客户端和源服务器之间的专用连接/会话期间的上下文。但是我们目前仍然只对每个会话的单个请求/响应对建模。
         * *
         * *注意:不是线程安全的，不打算并发使用----初始化得到一个16长度的hashmap存放终端信息
         */
...
//            context.setRouteVIP("SPRINGCLOUD-CLIENT")
        }
        
        System.out.println("-----------------------1111111111-------------");
//        context.set("SPRINGCLOUD-CLIENT", "http://192.168.1.17:8800");
//        context.set("SPRINGCLOUD-CLIENT");
