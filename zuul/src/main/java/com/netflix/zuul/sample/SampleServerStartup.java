...
public class SampleServerStartup extends BaseServerStartup {
    ...
    private static final ServerType SERVER_TYPE = ServerType.HTTP_MUTUAL_TLS;
...
//                        loadFromResources("server.cert"),
//                        loadFromResources("server.key"),
                        loadNewFromResources("server.crt"),
                        loadNewFromResources("serverpkcs8.key"),
                        null,
                        ClientAuth.REQUIRE,
//                        loadFromResources("truststore.jks"),
//                        loadFromResources("truststore.key"),
                        loadNewFromResources("trustmanager.keystore"),
                        loadNewFromResources("pass"),
                        false);
    ...
    private File loadNewFromResources(String s) {
        return new File(ClassLoader.getSystemResource("newssl/" + s).getFile());
    }
}
